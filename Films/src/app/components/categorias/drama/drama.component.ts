...
export class DramaComponent {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.filteredFilms = this.films.filter((film: Film) => film.genre.includes("Drama"));
    this.mostrarPeliculasDeDrama();
  }
  ...
  mostrarPeliculasDeDrama() {
    if (this.filteredFilms) {
      const contenedorGenero = document.getElementById("generoDrama");
