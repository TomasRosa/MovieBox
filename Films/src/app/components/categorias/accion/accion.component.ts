...
export class AccionComponent {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.filteredFilms = this.films.filter((film: Film) => film.genre.includes("Action"));
    this.mostrarPeliculasDeAccion();
  }
  ...
  mostrarPeliculasDeAccion() {
    if (this.filteredFilms) {
      const contenedorGenero = document.getElementById("generoAccion");
