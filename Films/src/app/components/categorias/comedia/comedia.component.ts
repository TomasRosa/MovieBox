...
export class ComediaComponent {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.filteredFilms = this.films.filter((film: Film) => film.genre.includes("Comedy"));
    this.mostrarPeliculasDeComedia();
  }
  ...
  mostrarPeliculasDeComedia() {
    if (this.filteredFilms) {
      const contenedorGenero = document.getElementById("generoComedia");
