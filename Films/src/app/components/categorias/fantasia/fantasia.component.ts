...
export class FantasiaComponent {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.filteredFilms = this.films.filter((film: Film) => film.genre.includes("Fantasy"));
    this.mostrarPeliculasDeFantasia();
  }
  ...
  mostrarPeliculasDeFantasia() {
    if (this.filteredFilms) {
      const contenedorGenero = document.getElementById("generoFantasia");
